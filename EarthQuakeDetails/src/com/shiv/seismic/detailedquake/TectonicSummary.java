...
public class TectonicSummary
{
    ...
    private TectonicSummaryContents contents;
    ...
    public TectonicSummaryContents getContents ()
    {
        return contents;
    }

    public void setContents (TectonicSummaryContents contents)
    {
